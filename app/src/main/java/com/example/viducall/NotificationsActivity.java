...
public class NotificationsActivity extends AppCompatActivity
{
    ...
    protected void onStart() {
       ...
       FirebaseRecyclerOptions options =
        ...
        FirebaseRecyclerAdapter<Contacts, NotifiactionsViewHolder> firebaseRecyclerAdapter
                = new FirebaseRecyclerAdapter<Contacts, NotifiactionsViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull final NotifiactionsViewHolder holder, int i, @NonNull Contacts contacts)
            {
                                                                                                            ...
                                                                                                            friendRequestRef.child(listUserId).child(currentUserId)
                                                                                                                    ...
                                                                                                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                                                        ...
                                                                                                                        public void onComplete(@NonNull Task<Void> task)
                                                                                                                        {
                                                                                                                            if (task.isSuccessful())
                                                                                                                            {
                                                                                                                                Toast.makeText(NotificationsActivity.this," Contact Saved",Toast.LENGTH_LONG).show();
                                                                                                                            }
                                                                                                                        }
                                                                                                                    });
                                                                                                        }
                                                                    ...
                                                                    friendRequestRef.child(currentUserId).child(listUserId)
                                                                            ...
                                                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                ...
                                                                                public void onComplete(@NonNull Task<Void> task)
                                                                                {
                                                                                    if (task.isSuccessful())
                                                                                    {
                                                                                        Toast.makeText(NotificationsActivity.this,"Friend Request Cancelled",Toast.LENGTH_LONG).show();
                                                                                    }
                                                                                }
                                                                            });
                                                                }
            ...
            @NonNull
            @Override
            public NotifiactionsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
            {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.find_friend_design, parent, false);
                NotifiactionsViewHolder viewHolder = new NotifiactionsViewHolder(view);
                return viewHolder;
            }
        };
    ...
    public static class NotifiactionsViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public NotifiactionsViewHolder(@NonNull View itemView) {
            super(itemView);
