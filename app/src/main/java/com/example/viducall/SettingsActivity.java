...
public class SettingsActivity extends AppCompatActivity
{
    ...
    private void saveUserData()
    {
        ...
        if (ImageUri  ==  null)
        {
            userRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot)
                {
                    ...
                    {
                        Toast.makeText(SettingsActivity.this,"please select an image",Toast.LENGTH_LONG).show();
                    }
                }
        ...
        {
            Toast.makeText(this,"userName is mandatory",Toast.LENGTH_LONG).toString();
        }


        else if(getUserStatus.equals(""))
        {
            Toast.makeText(this,"Bio is mandatory",Toast.LENGTH_LONG).toString();
        }
